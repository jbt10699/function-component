...
const render = (
    ...
    if (typeof reactElement === 'string' | typeof reactElement === 'number') {
        ...
        // // Assignment if it is function component
            ...
            console.log("We have a function component")
            const currFunctionComponent = type(props);
            console.log("CurrFunctionComponent is ", currFunctionComponent);
            render(currFunctionComponent, domElement);
            return;
        }
